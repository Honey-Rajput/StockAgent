...
def render():
    ...
    if not st.session_state.get('vp_results') and st.session_state.ALL_TAB_SCAN_STATUS["vp_results"] is not None:
        st.session_state.vp_results = st.session_state.ALL_TAB_SCAN_STATUS["vp_results"]
